...
export const FAME_MARKET_OG_SIZE = { width: 1200, height: 630 } as const;

export function createFameMarketOpenGraphImage(presentation: {
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          {/* next/og requires an HTML image element inside its generated SVG. */}
