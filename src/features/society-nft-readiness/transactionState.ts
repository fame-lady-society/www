...
> = {
  ...
  verification_mismatch:
    "FAME still reports a different Society NFT setting. Try again.",
  mint_not_detected:
    "The transfer confirmed, but no Society NFT mint was found in its receipt.",
};
...
interface TransactionStatusCopySet {
  awaitingWallet: ReadinessTransactionStatusCopy;
  confirming: ReadinessTransactionStatusCopy;
  verifying: ReadinessTransactionStatusCopy;
  confirmed: ReadinessTransactionStatusCopy;
  errorTitle: string;
  errorFallback: string;
}

const READINESS_STATUS_COPY: TransactionStatusCopySet = {
  awaitingWallet: {
  ...
  confirmed: {
    title: "Society NFT setting updated",
    detail: "FAME now reflects your selection.",
  },
  errorTitle: "Transaction not completed",
  errorFallback: "The transaction could not be completed.",
};

const RECONCILIATION_STATUS_COPY: TransactionStatusCopySet = {
  awaitingWallet: {
    title: "Confirm in your wallet",
    detail: "Review and submit the 1 wei self-transfer.",
  },
  confirming: {
  ...
  verifying: {
    ...
    detail: "Loading the Society NFTs generated by this transaction.",
  },
  confirmed: {
    title: "Society NFTs loaded",
    detail: "The generated Society NFTs are ready to view.",
  },
  errorTitle: "Transfer not completed",
  errorFallback: "The transfer could not be completed.",
};

function transactionStatusCopy(
  state: ReadinessTransactionState,
  copy: TransactionStatusCopySet,
...
export function readinessTransactionStatusCopy(
  ...
  return transactionStatusCopy(state, READINESS_STATUS_COPY);
}

export function reconciliationTransactionStatusCopy(
  state: ReadinessTransactionState,
): ReadinessTransactionStatusCopy | null {
  if (
    state.status === "error" &&
    state.error?.kind === "mint_not_detected"
  ) {
    return {
      title: "Transfer confirmed",
      detail: "No Society NFT was generated by this transaction.",
    };
  }

  return transactionStatusCopy(state, RECONCILIATION_STATUS_COPY);
}
