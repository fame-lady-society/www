  ...
  return (
    <>
      <AppMain title="FAMEus" isDao headerRight={<ChainSelector />}>
        <VideoWipeInteraction videoUrl={videoWipeUrl} redirectPath={`/${network}/fameus/wrap`} mustBeConnected>
          <div className="w-full pl-4 py-8">
            <div className="max-w-4xl mx-auto">
              <h1 className="text-4xl font-bold mb-6 text-center">FAMEus DAO Onboarding</h1>
